...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "USE_ASYNC_RESET" -parent ${Page_0}
...
proc update_PARAM_VALUE.USE_ASYNC_RESET { PARAM_VALUE.USE_ASYNC_RESET } {
	# Procedure called to update USE_ASYNC_RESET when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.USE_ASYNC_RESET { PARAM_VALUE.USE_ASYNC_RESET } {
	# Procedure called to validate USE_ASYNC_RESET
	return true
}
...
proc update_MODELPARAM_VALUE.USE_ASYNC_RESET { MODELPARAM_VALUE.USE_ASYNC_RESET PARAM_VALUE.USE_ASYNC_RESET } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.USE_ASYNC_RESET}] ${MODELPARAM_VALUE.USE_ASYNC_RESET}
}
